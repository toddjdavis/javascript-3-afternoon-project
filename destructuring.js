...
function totalPopulation (object) {
  ...
  var total = california + texas + utah + arizona
  return total
      }
...
//Code Here
function ingredients (cook){
  var {carb, fat, protein} = cook
  var myArray = [carb, fat, protein]
  return myArray
}
...
function largeNumbers (param){
  var {first, second, third} = param
